                ...
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> <a
                                href="welcome/add_blog">新增</a></button>
                    ...
                    foreach($blogs as $blog){
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button data-id="<?php echo $blog -> blog_id; ?>" class="bianji am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</button>
                                        <button data-id="<?php echo $blog -> blog_id; ?>" class="am-btn shanchu am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button>
                                    </div>
                                </div>
                            </td>
                        </tr>
    ...
    $(function(){
        $('.shanchu').on('click', function(){
            ...
            if(confirm('确定是否删除记录，不可恢复!?')){
                location.href = 'welcome/delete_blog?blog_id='+id;
            }
        });
        $('.bianji').on('click', function(){
            var id =  $(this).data('id');
            location.href = 'welcome/bianji_blog?blog_id='+id;
